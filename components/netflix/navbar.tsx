      ...
      >
        <div className="flex items-center justify-between px-4 md:px-8 lg:px-12 py-3 md:py-4">
          ...
          <div className="flex items-center gap-4 md:gap-8 lg:gap-10">
            ...
            >
              <span
                className="text-2xl md:text-3xl lg:text-4xl tracking-wider select-none"
                style={{
                  color: accentColor,
                ...
                {showSearch && (
                  ...
                  >
                    <input
                      ...
                      className="w-full bg-black/90 backdrop-blur-md border border-white/30 rounded-md text-base px-5 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-white/60 transition-colors"
